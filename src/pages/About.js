...
export default function About() {
  ...
  return (
    <div>
      <Helmet>
      <title>Om oss</title>
        <meta name="Om oss" content="Läs om Malmö ParkourKlubb" />
      </Helmet>
      <div className="bg-gray-950">
        ...
        <div className="flex justify-center py-12 px-12 text-white">
          <div className="max-w-xl">
            ...
            <p className="text-white sm:text-2xl">
              Vi är en grupp av tränare, atleter och föräldrar som tillsammans
              har tagit över den gamla parkourföreningen Quality Runners (QR),
              numera Malmö Parkourklubb (MPK), för att återskapa ett Parkourgym
              som Malmö förtjänar. Vår resa har precis börjat och vi har en bra
              bit kvar att gå, men tillsammans med er vill vi skapa en
              upplevelse för alla åldrar, oavsett om du har tränat parkour förut
              eller är nybörjare. Alla är välkomna!
            </p>
            ...
            <p className="sm:text-2xl">
              Om vi vill att Malmös största parkouranläggning ska finnas kvar,
              så kommer vi behöva hjälpas åt tillsammans. Alla vi på MPK jobbar
            ...
            <p className="text-white sm:text-2xl">
              ...
              och träna hos oss. Har du kompisar, barn eller syskon som vill
              testa på? Ta med allihopa! Just nu är det viktigaste att vi
              betalar av föreningens skuld så snabbt det går och får vi in 100
              medlemmar kommer föreningen vara skuldfri slutet av 2024.
            </p>
            <br></br>
            <p className="text-white sm:text-2xl">
              Tack för att du tog tiden att läsa om vår historia och hur vi
              tillsammans kan rädda parkour i Malmö. Klicka nedanför för att
              läsa mer om hur du kan bli medlem.
            </p>
            <button
              onClick={() => {
                navigate("/Membership");
